...
_NEXT_ACTIONS = {
    ...
    "JOB_OUTPUT_UNEXPECTED": "Inspect the preserved attempt with design_job_doctor and remove no files manually.",
    "JOB_DATABASE_COMMIT_UNKNOWN": "Run design_job_doctor before retrying; preserve the controlled attempt bytes.",
    "JOB_DATABASE_PUBLICATION_FAILED": "Refresh the Job state and retry the governed working-copy creation.",
    "JOB_ATTEMPT_RECOVERY_REQUIRED": "Run design_job_doctor before retrying; do not delete preserved attempt bytes.",
